...
class BaseParser(argparse.ArgumentParser):
  ...
  def __init__(self, add_help=False, data_dir=False, model_dir=True,
    ...
    if data_dir:
      self.add_argument(
          "--data_dir", "-dd", default="./ocrchar_train.tfrecords",
    ...
    if train_epochs:
      self.add_argument(
          "--train_epochs", "-te", type=int, default=30,
    ...
    if epochs_per_eval:
      self.add_argument(
          "--epochs_per_eval", "-epe", type=int, default=10,
    ...
    if batch_size:
      self.add_argument(
          "--batch_size", "-bs", type=int, default=256,
